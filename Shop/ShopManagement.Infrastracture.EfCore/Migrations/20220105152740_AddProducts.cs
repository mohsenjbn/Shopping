        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescribtion = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Describtion = table.Column<string>(type: "nvarchar(max)", maxLength: 20000, nullable: false),
                    ...
                    ProductCatagoryId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductCategories_ProductCatagoryId",
